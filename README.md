...
API сработает, если предварительно посоздавать датчики и правильно вызывать эндпоинты. Самое простое для проверки -- /health. Проверять желательно через [Postman-коллекцию](https://raw.githubusercontent.com/dbushenko/architecture-pro-warmhouse/refs/heads/warmhouse/apps/device-control.postman_collection.json).
...
- [Legacy Adapter API (AsyncAPI)](https://raw.githubusercontent.com/dbushenko/architecture-pro-warmhouse/warmhouse/schemas/legacy-adapter-asyncapi.yaml)

# Задание 5. Работа с docker и docker-compose

[temperature-api](https://github.com/dbushenko/architecture-pro-warmhouse/tree/warmhouse/apps/temperature-api)


# **Задание 6. Разработка MVP**

[Device Controller](https://github.com/dbushenko/architecture-pro-warmhouse/tree/warmhouse/apps/device-controller)

[Legacy Controller](https://github.com/dbushenko/architecture-pro-warmhouse/tree/warmhouse/apps/legacy-adapter)